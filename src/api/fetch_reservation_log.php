<?php
    ...
    $FETCHDATA = "SELECT reservation_log.reservation_id, restaurant.restaurant_name, reservation_log.reservation_time, reservation_log.table_number, reservation_log.status
                  FROM `reservation_log`
                  INNER JOIN `restaurant`
                  ON reservation_log.restaurant_id = restaurant.restaurant_id
                  WHERE reservation_log.user_id = $user_id
